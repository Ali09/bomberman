...
public class gameLogic
{
  ...
  public boolean walkableLocation(Location loc)
  {
  ...
  public void movePlayer(int playerNum, direction moveDirection)
  {
  ...
  // drop anymore bombs
  public void placeBomb(int playerNum)
  {
  ...
  public void explodeBomb(Location bombLoc, int bombRadius, int playerNum)
  {
    ...
    for (Location loc : locStack)
    {
      ...
      else
      {
        ...
        fireBallTimer(this, loc, 3 seconds);
      }
    }
