...
public class Project4 {
  ...
  public static void main(String[] args) {
    LocalOrNet locnet = new LocalOrNet();

    while (locnet.gameType.equals(" ")) {
      System.out.print("");
    }

    if (locnet.gameType.equals("NETWORK")) {
      local = false;
    }

    enterSeed getseed = new enterSeed();

    while (getseed.seedNum.equals(" ")) {
      System.out.print("");
    }

    seednum = Integer.parseInt(getseed.seedNum);

    networkWindow netWin = null;
    if (!local) {
    ...
    if (!local) {
      ...
      if (netWin.connectionType.equals("HOST")) {
        ...
        try {
          ...
          JLabel ipLabel = new JLabel("Current IP address : "
              + ip.getHostAddress());
        ...
        while (true) {
          ...
          switch (recvd) {
          case "UP_PRESSED_1":
            temp.velY = -temp.speed;
            break;
          case "DOWN_PRESSED_1":
            temp.velY = temp.speed;
            break;
          case "LEFT_PRESSED_1":
            temp.velX = -temp.speed;
            break;
          case "RIGHT_PRESSED_1":
            temp.velX = temp.speed;
            break;
          case "SPACE_PRESSED_1":
            temp.doBomb();
            break;
          case "UP_RELEASED_1":
            temp.velY = 0;
            break;
          case "DOWN_RELEASED_1":
            temp.velY = 0;
            break;
          case "LEFT_RELEASED_1":
            temp.velX = 0;
            break;
          case "RIGHT_RELEASED_1":
            temp.velX = 0;
            break;
          case "RESET":
            Reset starOver = new Reset(1);
            break;
          default:
            break;
          }
        ...
        while (true) {
          ...
          case "LEFT_PRESSED_0":
            temp.velX = -temp.speed;
            break;
          case "RIGHT_PRESSED_0":
            temp.velX = temp.speed;
            break;
          case "SPACE_PRESSED_0":
            temp.doBomb();
            break;
          case "UP_RELEASED_0":
            temp.velY = 0;
            break;
          case "DOWN_RELEASED_0":
            temp.velY = 0;
            break;
          case "LEFT_RELEASED_0":
            temp.velX = 0;
            break;
          case "RIGHT_RELEASED_0":
            temp.velX = 0;
            break;
          case "RESET":
            Reset startOver = new Reset(0);
            break;
          default:
            break;
          }
